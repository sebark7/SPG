...
bool RenderWindow::Initialize(ID3D11Device* device, int windowWidth, int windowHeight)
{
	bool result;
...
int RenderWindow::GetIndexCount()
{
	return m_indexCount;
}


bool RenderWindow::InitializeBuffers(ID3D11Device* device, int windowWidth, int windowHeight)
{
...
void RenderWindow::ShutdownBuffers()
{
...
void RenderWindow::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
