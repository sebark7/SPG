...
BumpModel::BumpModel(const BumpModel& other)
{
}
...
bool BumpModel::Initialize(ID3D11Device* device, char* modelFilename, WCHAR* textureFilename1, WCHAR* textureFilename2)
{
	bool result;
...
void BumpModel::Render(ID3D11DeviceContext* deviceContext)
{
...
bool BumpModel::InitializeBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void BumpModel::ShutdownBuffers()
{
...
bool BumpModel::LoadTextures(ID3D11Device* device, WCHAR* filename1, WCHAR* filename2)
{
	bool result;
...
void BumpModel::ReleaseTextures()
{
...
bool BumpModel::LoadModel(char* filename)
{
	ifstream fin;
	char input;
	int i;
