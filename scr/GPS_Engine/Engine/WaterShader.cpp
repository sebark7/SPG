...
bool WaterShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
...
bool WaterShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "WaterVertexShader", "vs_5_0",
...
bool WaterShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX&  worldMatrix, const XMMATRIX&  viewMatrix,
	const XMMATRIX&  projectionMatrix, const XMMATRIX&  reflectionMatrix,
	...
	float waterTranslation, float reflectRefractScale)
{
	...
	dataPtr2->reflection = XMMatrixTranspose(reflectionMatrix);
